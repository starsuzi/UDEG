...
with open('/home/syjeong/DocExpan/Antique-ir/data/text_format/tokenized/pegasus_test_text_cnn_dailymail_tokenized1', 'rb') as file:
...
if os.path.exists('/home/syjeong/DocExpan/Antique-ir/data/text_format/tokenized/test_pegasus_cnn_dailymail_beam8_minlen5_1'):
  os.remove('/home/syjeong/DocExpan/Antique-ir/data/text_format/tokenized/test_pegasus_cnn_dailymail_beam8_minlen5_1')
else:
  print("The file does not exist")

filePath = '/home/syjeong/DocExpan/Antique-ir/data/text_format/tokenized/test_pegasus_cnn_dailymail_beam8_minlen5_1'
